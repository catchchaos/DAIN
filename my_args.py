...
parser.add_argument('--datasetPath',default='datasets/vimeo90k',help = 'the path of selected datasets')
...
parser.add_argument('--numEpoch', '-e', type = int, default=50, help= 'Number of epochs to train(default:150)')
...
parser.add_argument('--lr', type =float, default= 0.0005, help= 'the basic learning rate for three subnetworks (default: 0.002)')
parser.add_argument('--rectify_lr', type=float, default=0.0005, help  = 'the learning rate for rectify/refine subnetworks (default: 0.001)')
...
parser.add_argument('--occ_lr_coe', type = float, default=0.0, help = 'relative learning rate w.r.t basic learning rate (default: 1.0)')
...
parser.add_argument('--patience', type=int, default=4, help = 'the patience of reduce on plateou')
